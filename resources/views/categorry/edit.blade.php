...
<body>
<form method="POST" action="{{route('categorry.update',$categorry->id)}}">
    @csrf
    @method('PUT')
  <div class="mb-3">
    <label for="exampleInputEmail1" class="form-label">name categorry</label>
    <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="name_categorry"
    value="{{$categorry->name_categorry}}">
  ...
  <div class="mb-3">
    ...
    value="{{$categorry->description_categorry}}">
  </div>
